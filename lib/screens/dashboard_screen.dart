...
class DashboardScreenState extends State<DashboardScreen>
{
  ...
  static final List<String> userDropdownItems = [ 'admin', 'logout' ];
  String actualUserDropdown = userDropdownItems[0];
  int actualUser = 0;
            ...
            (
              ...
              children: [
                DropdownButton
                          (
                            isDense: true,
                            value: actualUserDropdown,
                            onChanged: (String value) => setState(()
                            {
                              actualUser = actualUserDropdown.indexOf(value);
                            }),
                            items: userDropdownItems.map((String title)
                            {
                              return DropdownMenuItem
                              (
                                value: title,
                                child: Text(title, style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
                              );
                            }).toList()
                          )
                //Text('admin', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('Active projects', style: TextStyle(color: Colors.blueAccent)),
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    (
                      padding: const EdgeInsets.all(16.0),
                      child: Icon(Icons.mail, color: Colors.white, size: 30.0),
                    )
                  ),
                  Padding(padding: EdgeInsets.only(bottom: 16.0)),
                  Text('Message', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                  Text('Inbox (0)', style: TextStyle(color: Colors.black45)),
                ]
              ),
            ),
          ),
            ...
            (
              ...
              (
                ...
                [
                  ...
                  Text('No alerts ', style: TextStyle(color: Colors.black45)),
                ]
              ),
            ),
          ),
                      ...
                      (
                        ...
                        [
                          ...
                          (
                            ...
                            children: <Widget>
                            [
                              Text('Shipments', style: TextStyle(color: Colors.green)),
                              Text('23.531', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                            ],
                          ),
                          DropdownButton
                          (
